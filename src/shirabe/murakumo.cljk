...
(defn collection
  [name]
  (str "com.etzhayyim.shirabe." name))

(def cell-specs {
  :analyze {:legacy-cell "cell-shirabe-analyze"
     :phase :event
  ...
  :retrieve {:legacy-cell "cell-shirabe-retrieve"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "retrieve")]
     :required-gates common-gates
     :trigger "manifest cell retrieve"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :synthesize {:legacy-cell "cell-shirabe-synthesize"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "synthesize")]
     :required-gates common-gates
     :trigger "manifest cell synthesize"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :session {:legacy-cell "cell-shirabe-session"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "session")]
     :required-gates common-gates
     :trigger "manifest cell session"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kotoba {:legacy-cell "cell-shirabe-kotoba"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kotoba")]
     :required-gates common-gates
     :trigger "manifest cell kotoba"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :live {:legacy-cell "cell-shirabe-live"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "live")]
     :required-gates common-gates
     :trigger "manifest cell live"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
